-- Stock counts (listings, total users) ignore stats reset; only sales metrics reset.
...
begin
  ...
  -- Cumulative commerce metrics respect the reset baseline.
  ...
  select jsonb_build_object(
    ...
    -- Listing / user stock: range filter only (not wiped by reset).
    'new_listings', (
