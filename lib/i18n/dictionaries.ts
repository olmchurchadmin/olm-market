...
const ko = {
  ...
  nav: {
    ...
    sell: "판매등록",
    board: "자유게시판",
    boardUnreadAria: "읽지 않은 게시판 글 {count}개",
    login: "로그인",
    admin: "관리자",
    myAccount: "내 계정",
    signOut: "로그아웃",
  ...
  market: {
    ...
    buyHint:
      "구매후 판매자는 다음 주 성당에 물건을 맡기고, 구매자는 관리자에게 현금 결제 후 픽업합니다.",
    buyHintChurch:
      "구매후 판매자는 성당에 물건을 맡기고, 구매자는 관리자에게 현금 결제 후 픽업합니다.",
    buyHintSeller:
      "구매후 판매자와 직접 연락해 판매자 위치에서 픽업·결제합니다.",
    ownListingHint:
      "내가 올린 물건입니다. 다른 회원이 구매하면 알림을 받게 됩니다.",
    pickup: "픽업",
    ...
    condition: "물건 상태",
    quantity: "수량",
    quantityRemaining: "남은 수량 {remaining}",
    quantityRemainingOf: "남은 수량 {remaining} / {total}",
    quantityAvailableSold: "{available}개 남음 · {sold}개 판매",
    featured: "Featured",
    featuredSection: "Featured",
    noImage: "사진 없음",
    photosLoading: "이미지 로딩중…",
  ...
  sell: {
    ...
    photoProcessFailed: "사진을 처리하지 못했습니다. 다시 선택해 주세요.",
    photoNotImage: "이미지 파일만 올릴 수 있습니다.",
    photoUnsupported: "이 형식은 자동으로 줄일 수 없습니다. JPG/PNG로 바꿔 주세요.",
    photoTooLargeInput: "사진이 너무 큽니다. 12MB 이하 파일로 올려 주세요.",
    photoLoadFailed: "이미지를 불러오지 못했습니다.",
    photoEncodeFailed: "이미지를 줄이지 못했습니다.",
    photoStillTooLarge: "사진을 충분히 줄이지 못했습니다. 다른 사진을 선택해 주세요.",
    photoTotalTooLarge: "선택한 사진 용량이 너무 큽니다. 장수를 줄여 주세요.",
    removePhoto: "사진 제거",
    photoN: "사진 {n}",
    pickupMethod: "픽업 방법",
    ...
    quantityTooLow: "이미 판매된 수량보다 적게 설정할 수 없습니다.",
  },
  auth: {
    signIn: "로그인",
    signUp: "회원가입",
  ...
  account: {
    ...
    complaintAdminTitle: "문의/컴플레인",
    complaintAdminHint: "회원들이 보낸 문의와 컴플레인입니다. 답변하거나 삭제할 수 있습니다.",
    ...
    watchlist: "관심 목록",
    watchlistBlurb: "관심 있게 본 물건을 모아 두고, 여기서 바로 구매할 수 있습니다.",
    noWatchlist: "관심 목록이 비어 있습니다.",
    addToWatchlist: "관심 등록",
    removeFromWatchlist: "관심 해제",
    watchlistUnavailable: "지금은 구매할 수 없는 물품입니다.",
    watchlistRemoveCta: "목록에서 제거",
    notificationGroupBlurb:
      "같은 등록·거래의 알림을 한데 모아 진행 상태를 보여 줍니다.",
    notificationCurrentStatus: "현재 상태",
    notificationStatusPickupDetails: "픽업 정보 전달됨",
    notificationStatusOther: "알림",
    notificationTrackReserved: "거래 성립",
    notificationTrackAtChurch: "성당 도착",
    notificationTrackPickupDetails: "픽업 안내",
    notificationTrackCompleted: "거래 완료",
    notificationDeleteGroupAria: "이 거래 알림 모두 삭제",
    selling: "내가 파는 물건",
    noSelling: "등록한 물건이 없습니다.",
    sellerStatusLabel: "상태",
    sellerStatusDraft: "임시저장",
    sellerStatusPublished: "게시중",
    sellerStatusCompleted: "거래완료",
    sellerStatusSaved: "상태를 변경했습니다.",
    sellerStatusFailed: "상태를 변경하지 못했습니다.",
    relist: "재게시",
    relistTitle: "다시 게시할까요?",
    relistMessage:
      "이 물건을 다시 게시중으로 올릴까요? 남은 수량이 초기화됩니다.",
    relistFailed: "재게시에 실패했습니다.",
    buying: "내가 산 물건",
    noBuying: "구매 내역이 없습니다.",
    sellingOrders: "판매 진행 중인 거래",
    noSellingOrders: "진행 중인 판매 거래가 없습니다.",
    confirmDropoffTitle: "드롭오프 확인",
    confirmDropoffMessage:
      "성당에 물건을 맡기셨나요? 확인하면 구매자와 관리자에게 알림이 갑니다.",
    ...
    tradeDockSelling: "판매 진행 중",
    tradeDockBuying: "구매 진행 중",
    tradeDockMore: "외 {count}건",
    tradeDockViewAll: "내 거래 보기",
    tradeDockWaitingBuyer: "구매자 픽업을 기다리는 중",
    tradeDockWaitingSeller: "판매자 드롭오프를 기다리는 중",
    tradeDockSharePickupHint: "구매자에게 픽업 주소를 보내 주세요",
  ...
  admin: {
    ...
    rangeYear: "년",
    visitors: "방문자",
    visitorsHint: "기기당 하루 1회 집계 (관리자 페이지 제외)",
    visitorsTotal: "전체 방문자",
    visitorsDesktop: "데스크탑",
    visitorsMobile: "모바일",
    resetStats: "스탯 리셋",
    ...
    memberSavedFlash: "회원 정보를 저장했습니다.",
    editMember: "회원 수정",
    editMemberTitle: "회원 정보 수정",
    editMemberBlurb: "이름·연락처·알림 이메일·역할을 변경할 수 있습니다.",
    editMemberSave: "회원 저장",
    editMemberCancel: "목록으로",
    roleUser: "user",
    roleAdmin: "admin",
    roleSuperadmin: "superadmin",
    roleHint:
      "superadmin은 회원 수정·삭제까지 가능합니다. admin은 관리자 메뉴와 거래·문의 알림 메일을 받지만, 회원 정보는 바꿀 수 없습니다.",
    membersReadOnlyHint: "회원 수정·삭제는 superadmin만 할 수 있습니다.",
    complaintDeletedFlash: "컴플레인을 삭제했습니다.",
    orderDeletedFlash: "완료된 거래를 삭제했습니다.",
    listSearchPlaceholder: "검색",
    listingsSearchPlaceholder: "제목 · 판매자 · 등록 ID",
    featureListing: "Featured",
    unfeatureListing: "Featured 해제",
    ...
    joined: "가입일",
    complaints: "문의/컴플레인",
    noComplaints: "접수된 문의/컴플레인이 없습니다. 회원은 내 계정의 문의/컴플레인 탭에서 접수할 수 있습니다.",
    complaintResolvedFlash: "문의/컴플레인을 해결됨으로 표시했습니다.",
    unresolved: "미해결",
    resolved: "해결됨",
    markResolved: "해결됨 표시",
    resolveTitle: "문의/컴플레인 해결",
    resolveMessage: "이 문의/컴플레인을 해결 완료로 표시할까요?",
    deleteComplaint: "문의/컴플레인 삭제",
    deleteComplaintTitle: "문의/컴플레인 삭제",
    deleteComplaintMessage:
      "이 문의/컴플레인을 삭제할까요? 삭제 후 복구할 수 없습니다.",
    ...
    categoryUpdatedFlash: "카테고리를 수정했습니다.",
    categoryReorderedFlash: "카테고리 순서를 저장했습니다.",
    categoryDeleteTitle: "카테고리 삭제",
    categoryDeleteMessage:
      "「{name}」 카테고리를 삭제할까요? 이 카테고리의 리스팅이 있으면 삭제할 수 없습니다.",
    categoryDeleteConfirm: "삭제",
    categoryEdit: "카테고리 수정",
    categorySave: "저장",
    categoryEmpty: "등록된 카테고리가 없습니다.",
    categoryDragHint: "왼쪽 ≡ 아이콘을 드래그해서 순서를 바꾼 뒤 저장하세요.",
    categoryDragHandle: "순서 변경",
    categorySaveOrder: "순서 저장",
    noCategoriesSearch: "검색 결과가 없습니다.",
    bannerTab: "알림배너",
    bannerBlurb:
      "헤더 위 알림을 여러 개 미리 등록해 두고, 기간이 되면 자동으로 노출됩니다. 지난 알림은 삭제하세요.",
    bannerNew: "새 알림",
    bannerNewTitle: "새 알림 등록",
    bannerEditTitle: "알림 수정",
    bannerEdit: "수정",
    bannerDelete: "삭제",
    bannerDeleteTitle: "알림 삭제",
    bannerDeleteMessage: "이 알림을 삭제할까요? 삭제 후 복구할 수 없습니다.",
    bannerEmpty: "등록된 알림이 없습니다. 새 알림을 추가해 보세요.",
    bannerBodyEmpty: "(문구 없음)",
    bannerEnabled: "배너 표시",
    bannerBodyKo: "알림 문구",
    bannerBodyEn: "문구 (영어)",
    ...
    bannerScheduleLabel: "노출 기간",
    bannerStartsAt: "시작일",
    bannerEndsAt: "종료일",
    bannerScheduleHint:
      "날짜만 고르면 됩니다. 시작일은 그날 0시부터, 종료일은 그날 끝까지 표시됩니다. 비우면 상시 노출입니다.",
    bannerScheduleAlways: "기간: 상시 노출",
    bannerScheduleFrom: "기간: {start}부터",
    bannerScheduleUntil: "기간: {end}까지",
    bannerScheduleRange: "기간: {start} ~ {end}",
    bannerPresetAlways: "상시",
    ...
    bannerSave: "배너 저장",
    bannerSavedFlash: "알림배너를 저장했습니다.",
    bannerDeletedFlash: "알림을 삭제했습니다.",
    bannerDismiss: "알림 닫기",
    bannerStatusOff: "상태: 꺼짐",
    bannerStatusLive: "상태: 지금 노출 중",
    bannerStatusScheduled: "상태: 시작 대기",
    bannerStatusExpired: "상태: 기간 종료",
    bannerStatusOffShort: "꺼짐",
    bannerStatusLiveShort: "노출 중",
    bannerStatusScheduledShort: "예정",
    bannerStatusExpiredShort: "종료",
    deleteCompletedOrder: "완료 거래 삭제",
    deleteCompletedOrderTitle: "완료 거래 삭제",
    deleteCompletedOrderMessage:
      "「{title}」 완료된 거래를 삭제할까요? 삭제 후 복구할 수 없습니다.",
    deleteCompletedOrderConfirm: "삭제",
    orders: "주문 파이프라인",
    ...
    confirmDropoffTitle: "드롭오프 확인",
    confirmDropoffMessage:
      "판매자가 성당에 물건을 맡겼나요? 관리자 확인은 판매자 확인을 대신합니다. 구매자와 관리자에게 알림이 갑니다.",
    confirmDropoffCta: "드롭오프 확인",
    confirmPickupTitle: "픽업 확인",
    confirmPickupMessage:
      "구매자가 성당에서 픽업·현금 결제를 마쳤나요? 관리자 확인은 구매자 확인을 대신합니다. 판매자와 관리자에게 알림이 갑니다.",
    confirmPickupCta: "픽업 확인",
    complete: "완료",
    noOrders: "주문이 없습니다.",
    pickup: "픽업방법",
  ...
  buy: {
    ...
    confirmTitle: "구매 확인",
    confirmMessage:
      "선택한 수량만큼 예약할까요? 확인하면 해당 수량만큼 거래가 시작됩니다.",
    confirmCta: "구매 확인",
  },
  alerts: {
  ...
  errors: {
    ...
    watchlistOwnListing: "내가 올린 물품은 관심 목록에 넣을 수 없습니다.",
    ...
    deleteComplaintFailed: "문의/컴플레인을 삭제하지 못했습니다.",
    categoryCreateFailed: "카테고리를 추가하지 못했습니다.",
    categoryUpdateFailed: "카테고리를 수정하지 못했습니다.",
    categoryDeleteFailed: "카테고리를 삭제하지 못했습니다.",
    categoryDeleteInUse: "이 카테고리를 쓰는 리스팅이 있어 삭제할 수 없습니다.",
    categoryReorderFailed: "카테고리 순서를 저장하지 못했습니다.",
    categoryNameRequired: "카테고리 이름을 입력해 주세요.",
    bannerTextRequired: "배너를 켜려면 본문 텍스트를 입력해 주세요.",
    bannerScheduleInvalid: "시작일이 종료일보다 늦을 수 없습니다.",
    bannerSaveFailed: "알림배너를 저장하지 못했습니다.",
    bannerDeleteFailed: "알림을 삭제하지 못했습니다.",
    ...
    memberSaveFailed: "회원 정보를 저장하지 못했습니다.",
    memberNotFound: "회원을 찾을 수 없습니다.",
    cannotDemoteSelf: "본인 역할은 변경할 수 없습니다.",
    cannotDemoteLastAdmin: "마지막 관리자 역할은 해제할 수 없습니다.",
  },
  status: {
    draft: "임시저장",
    available: "판매중",
  ...
  board: {
    ...
    replySubmit: "답글 등록",
    replyRequired: "답글 내용을 입력해 주세요.",
    noReplies: "아직 답글이 없습니다.",
    edit: "수정",
    delete: "삭제",
    deletePostTitle: "글 삭제",
    deletePostMessage: "이 글을 삭제할까요? 답글도 함께 삭제됩니다.",
    deleteReplyTitle: "답글 삭제",
    deleteReplyMessage: "이 답글을 삭제할까요?",
    deletedFlash: "글을 삭제했습니다.",
    author: "작성자",
    back: "목록",
    titleTooLong: "제목은 120자 이내로 입력해 주세요.",
...
const en: Dictionary = {
  ...
  nav: {
    ...
    boardUnreadAria: "{count} unread board posts",
    login: "Log in",
    admin: "Admin",
  ...
  market: {
    ...
    condition: "Condition",
    quantity: "Quantity",
    quantityRemaining: "{remaining} left",
    quantityRemainingOf: "{remaining} / {total} left",
    quantityAvailableSold: "{available} available · {sold} sold",
    featured: "Featured",
    featuredSection: "Featured",
    noImage: "No image",
  ...
  sell: {
    ...
    photoProcessFailed: "Couldn’t process that photo. Please choose again.",
    photoNotImage: "Only image files can be uploaded.",
    photoUnsupported: "This format can’t be resized automatically. Use JPG/PNG.",
    photoTooLargeInput: "That photo is too large. Please use a file under 12MB.",
    photoLoadFailed: "Couldn’t load that image.",
    photoEncodeFailed: "Couldn’t resize that image.",
    photoStillTooLarge: "Couldn’t shrink that photo enough. Try another one.",
    photoTotalTooLarge: "Those photos are too large together. Please choose fewer.",
    ...
    quantity: "Quantity",
    quantityHint:
      "List multiple identical items. Remaining count drops as each unit sells.",
    condition: "Condition",
    conditionNew: "New",
    conditionUsed: "Used",
    ...
    quantityTooLow: "Quantity cannot be lower than units already sold.",
  },
  auth: {
    signIn: "Log in",
    signUp: "Sign up",
  ...
  account: {
    ...
    complaintAdminTitle: "Inquiries / complaints",
    complaintAdminHint:
      "Inquiries and complaints submitted by members. You can reply or delete here.",
    ...
    watchlistBlurb:
      "Save items you're interested in, and buy them from here when you're ready.",
    noWatchlist: "Your watchlist is empty.",
    addToWatchlist: "Add to watchlist",
    removeFromWatchlist: "Remove from watchlist",
    watchlistUnavailable: "This item is not available to buy right now.",
    watchlistRemoveCta: "Remove",
    notificationGroupBlurb:
      "Alerts for the same listing or trade are grouped so you can follow progress.",
    notificationCurrentStatus: "Current status",
    notificationStatusPickupDetails: "Pickup details sent",
    notificationStatusOther: "Alert",
    notificationTrackReserved: "Trade started",
    notificationTrackAtChurch: "At church",
    notificationTrackPickupDetails: "Pickup info",
    notificationTrackCompleted: "Completed",
    notificationDeleteGroupAria: "Delete all alerts for this trade",
    selling: "Items I'm selling",
    noSelling: "No listings yet.",
    sellerStatusLabel: "Status",
    sellerStatusDraft: "Draft",
    sellerStatusPublished: "Published",
    sellerStatusCompleted: "Completed",
    sellerStatusSaved: "Status updated.",
    sellerStatusFailed: "Could not update the status.",
    relist: "Relist",
    relistTitle: "Relist this item?",
    relistMessage:
      "Publish this item again? Remaining quantity will be reset.",
    relistFailed: "Could not relist the item.",
    ...
    confirmDropoffMessage:
      "Did you drop the item off at church? Buyer and admin will be notified.",
    ...
    tradeDockSelling: "Sale in progress",
    tradeDockBuying: "Purchase in progress",
    tradeDockMore: "+{count} more",
    tradeDockViewAll: "My activity",
    tradeDockWaitingBuyer: "Waiting for buyer pickup",
    tradeDockWaitingSeller: "Waiting for seller dropoff",
    tradeDockSharePickupHint: "Send the buyer your pickup address",
  ...
  admin: {
    ...
    rangeYear: "Year",
    visitors: "Visitors",
    visitorsHint: "Counted once per device per day (admin pages excluded)",
    visitorsTotal: "Total visitors",
    visitorsDesktop: "Desktop",
    visitorsMobile: "Mobile",
    ...
    memberSavedFlash: "Member saved.",
    editMember: "Edit member",
    editMemberTitle: "Edit member",
    editMemberBlurb: "Update name, contact, notification email, and role.",
    editMemberSave: "Save member",
    editMemberCancel: "Back to list",
    roleUser: "user",
    roleAdmin: "admin",
    roleSuperadmin: "superadmin",
    roleHint:
      "Superadmins can edit and delete members. Admins get the admin console and trade/inquiry emails, but cannot change member records.",
    membersReadOnlyHint: "Only superadmins can edit or delete members.",
    complaintDeletedFlash: "Complaint deleted.",
    orderDeletedFlash: "Completed trade deleted.",
    ...
    role: "Role",
    joined: "Joined",
    complaints: "Inquiries / complaints",
    noComplaints:
      "No inquiries yet. Members can submit from the Support / complaint tab.",
    complaintResolvedFlash: "Marked the inquiry as resolved.",
    unresolved: "Open",
    resolved: "Resolved",
    markResolved: "Mark resolved",
    resolveTitle: "Resolve inquiry",
    resolveMessage: "Mark this support request as resolved?",
    deleteComplaint: "Delete inquiry",
    deleteComplaintTitle: "Delete inquiry",
    deleteComplaintMessage:
      "Delete this inquiry/complaint? This cannot be undone.",
    ...
    categoryUpdatedFlash: "Category updated.",
    categoryReorderedFlash: "Category order saved.",
    categoryDeleteTitle: "Delete category",
    categoryDeleteMessage:
      "Delete “{name}”? Categories that still have listings cannot be deleted.",
    categoryDeleteConfirm: "Delete",
    categoryEdit: "Edit category",
    categorySave: "Save",
    categoryEmpty: "No categories yet.",
    categoryDragHint: "Drag the ≡ handle to reorder, then save.",
    categoryDragHandle: "Reorder",
    categorySaveOrder: "Save order",
    noCategoriesSearch: "No matching categories.",
    bannerTab: "Alert banner",
    bannerBlurb:
      "Register multiple header alerts ahead of time. They go live on schedule; delete past ones when done.",
    bannerNew: "New alert",
    bannerNewTitle: "New alert",
    bannerEditTitle: "Edit alert",
    bannerEdit: "Edit",
    bannerDelete: "Delete",
    bannerDeleteTitle: "Delete alert",
    bannerDeleteMessage: "Delete this alert? This cannot be undone.",
    bannerEmpty: "No alerts yet. Add one to get started.",
    bannerBodyEmpty: "(No message)",
    ...
    bannerScheduleLabel: "Schedule",
    bannerStartsAt: "Start date",
    bannerEndsAt: "End date",
    bannerScheduleHint:
      "Pick dates only. Starts at midnight on the start date and ends at the end of the end date. Leave blank for always-on.",
    bannerScheduleAlways: "Schedule: always on",
    bannerScheduleFrom: "Schedule: from {start}",
    bannerScheduleUntil: "Schedule: until {end}",
    bannerScheduleRange: "Schedule: {start} – {end}",
    bannerPresetAlways: "Always",
    ...
    bannerSavedFlash: "Alert banner saved.",
    bannerDeletedFlash: "Alert deleted.",
    bannerDismiss: "Dismiss alert",
    bannerStatusOff: "Status: off",
    bannerStatusLive: "Status: live now",
    bannerStatusScheduled: "Status: scheduled",
    bannerStatusExpired: "Status: ended",
    bannerStatusOffShort: "Off",
    bannerStatusLiveShort: "Live",
    bannerStatusScheduledShort: "Scheduled",
    bannerStatusExpiredShort: "Ended",
    deleteCompletedOrder: "Delete completed trade",
    deleteCompletedOrderTitle: "Delete completed trade",
    deleteCompletedOrderMessage:
      "Delete the completed trade for “{title}”? This cannot be undone.",
    deleteCompletedOrderConfirm: "Delete",
    ...
    confirmDropoffTitle: "Confirm dropoff",
    confirmDropoffMessage:
      "Did the seller drop the item off at church? Admin confirmation overrides the seller. Buyer and admin are notified.",
    confirmDropoffCta: "Confirm dropoff",
    confirmPickupTitle: "Confirm pickup",
    confirmPickupMessage:
      "Did the buyer pick up and pay cash at church? Admin confirmation overrides the buyer. Seller and admin are notified.",
    confirmPickupCta: "Confirm pickup",
    complete: "Complete",
  ...
  buy: {
    ...
    confirmMessage:
      "Reserve the selected quantity? Once confirmed, that many units enter the trade flow.",
  ...
  notify: {
    ...
    complaintReplyBody: "An admin replied to 「{subject}」.",
    detailItem: "Item",
    detailSeller: "Seller",
    detailBuyer: "Buyer",
  ...
  errors: {
    ...
    watchlistOwnListing: "You can't add your own listing to the watchlist.",
    ...
    deleteComplaintFailed: "Could not delete the inquiry.",
    categoryCreateFailed: "Could not add the category.",
    categoryUpdateFailed: "Could not update the category.",
    categoryDeleteFailed: "Could not delete the category.",
    categoryDeleteInUse:
      "This category still has listings and cannot be deleted.",
    categoryReorderFailed: "Could not save category order.",
    categoryNameRequired: "Please enter a category name.",
    bannerTextRequired: "Enter banner text before turning it on.",
    bannerScheduleInvalid: "Start date cannot be after end date.",
    bannerSaveFailed: "Could not save the alert banner.",
    bannerDeleteFailed: "Could not delete the alert.",
    ...
    cannotDemoteLastAdmin: "You cannot remove the last admin role.",
  },
  status: {
    draft: "Draft",
    available: "Available",
  ...
  board: {
    ...
    deletePostMessage: "Delete this post? Replies will be removed too.",
    deleteReplyTitle: "Delete reply",
    deleteReplyMessage: "Delete this reply?",
    deletedFlash: "Post deleted.",
    author: "Author",
    back: "Back",
    ...
    noticeLabel: "Notice",
    noticeHint: "Checked notices stay pinned at the top of the list.",
  },
};
