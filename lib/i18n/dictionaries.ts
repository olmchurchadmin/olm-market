...
const ko = {
  ...
  admin: {
    ...
    smsTitle: "SMS 테스트",
    smsBlurb:
      "관리자 프로필 번호로 Twilio 테스트 문자를 보냅니다. 거래 알림과 같은 경로를 씁니다.",
    smsCta: "테스트 문자 보내기",
    smsNoPhone: "먼저 내 계정 프로필에 휴대폰 번호를 저장해 주세요.",
    smsJobs: "최근 SMS 발송 로그",
    smsNoJobs: "아직 SMS 발송 기록이 없습니다.",
    smsStatus: "상태",
    smsError: "오류",
    smsRecipient: "수신",
    smsTime: "시각",
...
const en: Dictionary = {
  ...
  admin: {
    ...
    smsTitle: "SMS test",
    smsBlurb:
      "Send a Twilio test SMS to the admin profile phone using the same path as trade alerts.",
    smsCta: "Send test SMS",
    smsNoPhone: "Save a mobile number on your profile first.",
    smsJobs: "Recent SMS jobs",
    smsNoJobs: "No SMS jobs yet.",
    smsStatus: "Status",
    smsError: "Error",
    smsRecipient: "To",
    smsTime: "Time",
