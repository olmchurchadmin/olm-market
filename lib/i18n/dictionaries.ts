...
const ko = {
  ...
  siteFooter: {
    contactLabel: "연락처",
    contact: "(714) 555-0188 · market@olmparish.example",
    contactPersonLabel: "담당자",
    contactPerson: "김마리아 (장터 봉사팀)",
    addressLabel: "성당 주소",
    address: "123 Mercy Way, Anaheim, CA 92801",
    note: "임시 연락처입니다. 추후 실제 정보로 교체됩니다.",
  },
  market: {
    title: "장터",
...
const en: Dictionary = {
  ...
  siteFooter: {
    ...
    contactPerson: "Maria Kim (Market volunteers)",
    addressLabel: "Church address",
    address: "123 Mercy Way, Anaheim, CA 92801",
    note: "Placeholder contact info — replace with real details later.",
  },
  market: {
    title: "Market",
