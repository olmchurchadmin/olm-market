...
const ko = {
  ...
  admin: {
    ...
    bannerTab: "노티 배너",
    bannerBlurb:
      "헤더 바로 아래에 표시되는 공지 배너입니다. 이미지·문구·CTA·노출 기간을 설정하세요.",
    bannerEnabled: "배너 표시",
    bannerBodyKo: "본문 (한국어)",
    bannerBodyEn: "본문 (영어)",
    ...
    bannerStartsAt: "시작 시간",
    bannerEndsAt: "종료 시간",
    bannerScheduleHint:
      "시작·종료를 비우면 켜져 있는 동안 항상 표시됩니다. 시간은 이 기기의 로컬 시간입니다.",
    bannerImage: "배너 이미지",
    bannerImageEmpty: "등록된 이미지가 없습니다.",
    bannerClearImage: "이미지 삭제",
    bannerSave: "배너 저장",
    bannerSavedFlash: "노티 배너를 저장했습니다.",
  ...
  errors: {
    ...
    bannerScheduleInvalid: "시작 시간이 종료 시간보다 늦을 수 없습니다.",
    bannerSaveFailed: "노티 배너를 저장하지 못했습니다.",
...
const en: Dictionary = {
  ...
  admin: {
    ...
    bannerTab: "Notice banner",
    bannerBlurb:
      "Configure the notice banner shown directly under the header: image, copy, CTA, and schedule.",
    bannerEnabled: "Show banner",
    bannerBodyKo: "Body (Korean)",
    bannerBodyEn: "Body (English)",
    bannerCtaLabelKo: "CTA label (Korean)",
    bannerCtaLabelEn: "CTA label (English)",
    bannerCtaUrl: "CTA link URL",
    bannerStartsAt: "Start time",
    bannerEndsAt: "End time",
    bannerScheduleHint:
      "Leave start/end empty to show whenever enabled. Times use this device’s local timezone.",
    bannerImage: "Banner image",
    bannerImageEmpty: "No image uploaded.",
    bannerClearImage: "Remove image",
    bannerSave: "Save banner",
    bannerSavedFlash: "Notice banner saved.",
  ...
  errors: {
    ...
    bannerScheduleInvalid: "Start time cannot be after end time.",
    bannerSaveFailed: "Could not save the notice banner.",
