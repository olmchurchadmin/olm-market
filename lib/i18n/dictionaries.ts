...
const ko = {
  ...
  admin: {
    ...
    roleAdmin: "admin",
    roleHint:
      "admin은 회원 수정·삭제까지 가능합니다. manager는 관리자 메뉴와 거래·문의 알림 메일을 받지만, 회원 정보는 바꿀 수 없습니다.",
    membersReadOnlyHint: "회원 수정·삭제는 admin만 할 수 있습니다.",
...
const en: Dictionary = {
  ...
  admin: {
    ...
    roleAdmin: "admin",
    roleHint:
      "Admins can edit and delete members. Managers get the admin console and trade/inquiry emails, but cannot change member records.",
    membersReadOnlyHint: "Only admins can edit or delete members.",
